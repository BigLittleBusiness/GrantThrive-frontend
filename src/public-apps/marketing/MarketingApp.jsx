                ...
                <div className='flex items-center space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-blue-100'>
                      Let citizens vote on grant priorities
                    </p>
                  </div>
                </div>
                <div className='flex items-center space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-blue-100'>
                      Visualize grant impact across your region
                    </p>
                  </div>
                </div>
                <div className='flex items-center space-x-3'>
            ...
            <div className='space-y-6'>
              ...
              <div className='flex items-center space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-blue-100'>
                    Save $3,000-$8,000 in setup costs
                  </p>
                </div>
              </div>
              <div className='flex items-center space-x-4'>
    ...
    <footer className='bg-gray-900 text-white py-12'>
      <div className='container-custom'>
        ...
        <div className='border-t border-gray-800 mt-8 pt-8 text-center text-gray-400'>
          <p>
            {new Date().getFullYear()} GrantThrive. All rights reserved.
            Transforming grant management across Australia and New Zealand.
          </p>
        </div>
      </div>
    </footer>
...
function FeaturesPage() {
  ...
  const allFeatures = [
    ...
    },
    {
      ...
      description:
        'Built-in messaging, automated status updates, and email notifications keep applicants informed at every stage.',
      badge: 'Core',
      color: 'bg-cyan-500',
    },
    {
      ...
      description:
        'Generate QR codes for any grant program. Place them on posters, flyers, and signage to drive community applications.',
      badge: 'Unique',
      color: 'bg-pink-500',
    },
    {
    ...
    },
    {
      ...
      description:
        'Automated monthly PDF reports delivered to council administrators covering all key metrics and financial summaries.',
      badge: 'Automated',
      color: 'bg-lime-600',
    },
  ]
      ...
      <div className='container-custom'>
        <div className='text-center space-y-4 mb-16'>
          ...
          <h1 className='text-3xl lg:text-5xl font-bold text-gray-900'>
            Everything You Need to Run Better Grants
          </h1>
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            GrantThrive brings together every tool a council needs to manage
            grants efficiently and engage the community meaningfully.
          </p>
        </div>
...
function mergeLivePricing(apiPlans) {
  return FALLBACK_PLANS.map((plan) => {
    ...
    return {
      ...
      annualTotal,
      addonVotingCents:
        live.addon_community_voting_cents ?? plan.addonVotingCents,
      addonMappingCents:
        live.addon_grant_mapping_cents ?? plan.addonMappingCents,
    }
  })
}
    ...
    <div className='section-padding bg-gray-50'>
      <div className='container-custom'>
        <div className='text-center space-y-4 mb-10'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            All plans include setup, training, and ongoing support. Cancel
            anytime.
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-3 gap-8 mb-10'>
          {plans.map((plan, index) => (
            <Card
              key={index}
              className={`relative border-0 shadow-lg ${plan.highlight ? 'ring-2 ring-primary' : ''}`}
            >
              {plan.highlight && (
                ...
                <div className='mt-4'>
                  ...
                  {isAnnual ? (
                    <div className='mt-2 space-y-1'>
                      ...
                      <p className='text-sm text-gray-500'>
                        Billed as ${plan.annualTotal.toLocaleString()}/year
                      </p>
                    </div>
                  ) : (
                    <div className='mt-2'>
                  ...
                  <div className='border-t pt-4'>
                    ...
                    {plan.addonVotingCents && (
                      <p className='text-sm text-gray-600'>
                        + Community Voting +$
                        {Math.round(plan.addonVotingCents / 100)}/mo
                      </p>
                    )}
                    {plan.addonMappingCents && (
                      <p className='text-sm text-gray-600'>
                        + Grant Mapping +$
                        {Math.round(plan.addonMappingCents / 100)}/mo
                      </p>
                    )}
                  </div>
                )}
        ...
        {!isAnnual && (
          <div className='bg-gradient-to-r from-primary/10 to-green-50 border border-primary/20 rounded-2xl p-6 mb-12 text-center'>
            ...
            <p className='text-gray-600 text-sm mb-4'>
              {plans.map((p, i) => (
                <span key={p.key}>
                  {p.name} save ${(p.monthlyPrice * 2).toLocaleString()}/year
                  {i < plans.length - 1 ? ' • ' : ''}
                </span>
              ))}
            </p>
...
function ROICalculatorPage() {
  ...
  const calculateROI = (inputs) => {
    const currentAnnualCosts =
      inputs.applications * inputs.hoursPerApp * inputs.hourlyRate +
      inputs.techCosts +
      inputs.adminCosts
    const grantThriveAnnualCost =
      inputs.councilSize === 'small'
        ? 2400
        : inputs.councilSize === 'medium'
          ? 6000
          : 13200
    const addOnCosts =
      (inputs.communityVoting ? 600 : 0) + (inputs.grantMapping ? 600 : 0)
    ...
    <div className='section-padding bg-gray-50'>
      <div className='container-custom'>
        <div className='text-center space-y-4 mb-12'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            See exactly how much your council can save. Adjust the inputs below
                ...
                <div className='space-y-4'>
                  <div className='flex justify-between'>
                    ...
                    <span className='font-semibold'>
                      ${results.currentAnnualCosts.toLocaleString()}
                    </span>
                  </div>
                  <div className='flex justify-between'>
                    <span>GrantThrive Annual Cost:</span>
                    <span className='font-semibold'>
                      ${results.totalGrantThriveCost.toLocaleString()}
                    </span>
                  </div>
  ...
  const resources = [
    {
      ...
      description:
        'A step-by-step guide to writing compelling grant applications that get approved.',
      category: 'Guide',
      link: '/resources/GrantThrive_Grant_Writing_Guide.pdf',
    },
    {
      icon: FileText,
      title: 'Application Checklist',
      description:
        'A printable checklist covering everything applicants need before submitting.',
      category: 'Template',
      link: '/resources/GrantThrive_Application_Checklist.pdf',
    },
    {
      icon: BarChart3,
      title: 'Council ROI Report Template',
      description:
        'A ready-to-use template for reporting grant program outcomes to your council.',
      category: 'Template',
      link: '/resources/GrantThrive_Council_ROI_Report_Template.pdf',
    },
    {
      icon: Users,
      title: 'Community Engagement Playbook',
      description:
        'Best practices for driving community participation in your grant programs.',
      category: 'Guide',
      link: '/resources/GrantThrive_Community_Engagement_Playbook.pdf',
    },
    {
      icon: Shield,
      title: 'Compliance & Governance Guide',
      description:
        'Understand your obligations under Australian grant administration frameworks.',
      category: 'Guide',
      link: '/resources/GrantThrive_Compliance_Governance_Guide.pdf',
    },
    {
      icon: TrendingUp,
      title: 'Grant Program Metrics Guide',
      description:
        'Learn which KPIs matter most and how to measure grant program success.',
      category: 'Guide',
      link: '/resources/GrantThrive_Grant_Program_Metrics_Guide.pdf',
    },
  ]
    ...
    <div className='section-padding'>
      <div className='container-custom'>
        <div className='text-center space-y-4 mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Guides, templates, and playbooks for council administrators and
            grant applicants.
          </p>
        </div>
      ...
      <div className='section-padding'>
        <div className='container-custom max-w-2xl mx-auto text-center'>
          ...
          <p className='text-xl text-gray-600 mb-8'>
            We have received your message and will be in touch within one
            business day.
          </p>
          ...
          <div className='space-y-8'>
            ...
            <Card className='border-0 shadow-lg bg-primary text-white p-6'>
              ...
              <p className='text-blue-100 mb-4'>
                See GrantThrive in action with a personalised 30-minute
                walkthrough tailored to your council's needs.
              </p>
              <ul className='space-y-2 text-sm text-blue-100 mb-4'>
                <li className='flex items-center gap-2'>
                  <CheckCircle className='h-4 w-4 text-white' /> No obligation
                </li>
                <li className='flex items-center gap-2'>
                  <CheckCircle className='h-4 w-4 text-white' /> Tailored to
                  your council size
                </li>
                <li className='flex items-center gap-2'>
                  <CheckCircle className='h-4 w-4 text-white' /> Live Q&amp;A
                  with our team
                </li>
              </ul>
            </Card>
